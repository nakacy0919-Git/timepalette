...
export default function Header({ activeTab, setActiveTab }) {
  ...
  return (
    <div className="w-full bg-white border-b border-gray-200 shadow-sm flex items-center justify-between px-6 py-3 overflow-x-auto">
      {/* ロゴ部分 */}
      <div className="text-2xl font-black text-slate-800 tracking-wider shrink-0 mr-6">
          ...
          if (item.url) {
            return (
              <a
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-full text-sm font-bold transition-all text-gray-500 hover:bg-gray-100 hover:text-gray-800 whitespace-nowrap"
              >
                {item.icon}
                {item.label}
              </a>
